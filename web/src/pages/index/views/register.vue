<template>
  <div class="login-wrap">
    <el-form label-position="left" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="140px" class="demo-ruleForm login-container">
      ...
      <el-form-item prop="verpassword" label="请确认密码:">
        ...
        <el-radio-group v-model="ruleForm.IdRule">
          ...
          <el-radio label="2">医院管理</el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item prop="cname" v-if="ruleForm.IdRule == 2" :rules="ruleForm.IdRule == '2' ? rules.customProID : [{ required: false}]" label="请输入医院名称：">
        <el-input type="cname" v-model="ruleForm.cname" auto-complete="off" placeholder="企业名称"></el-input></el-form-item>
        <el-form-item v-if="ruleForm.IdRule == 2" prop="cinf" label="请输入医院信息：">
        <el-input

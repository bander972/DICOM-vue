...
<template>
   ...
   <el-row class="Container">
    ...
    <div class="menuBar">
     ...
     <img
      ...
      :src="require('I:/DICOMplatform/vuedicom-demo/DICOM-vue/vuedicom-demo/public/images/'+completeMark)"
     ...
     <img
      ...
      :src="require('I:/DICOMplatform/vuedicom-demo/DICOM-vue/vuedicom-demo/public/images/'+waitMark)"
    ...
    <div class="mainBar">
     ...
     <div class="tool">
      ...
      :src="require('I:/DICOMplatform/vuedicom-demo/DICOM-vue/vuedicom-demo/public/images/'+rectangleRoiImg)"
     ...
     <div class="tool">
      ...
      :src="require('I:/DICOMplatform/vuedicom-demo/DICOM-vue/vuedicom-demo/public/images/'+eraserImg)"
  ...
  export default {
   ...
   return {
    ...
    completeMark:"yiwancheng.png",

    // 未标注

    waitMark: "daishenhe.png",

    // 标注笔

    rectangleRoiImg: "pencil.png",

    // 橡皮擦

    eraserImg: "eraser.png",
